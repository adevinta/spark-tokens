...
extension Color {
  ...
  public static var brandBaseOnSurface: Color {
    return Color.init("brandBaseOnSurface", bundle: bundle)
  }
  public static var brandBaseSurfaceInverse: Color {
    return Color.init("brandBaseSurfaceInverse", bundle: bundle)
  }
